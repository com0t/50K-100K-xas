 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
    ...
    <form name="additem">
      ...
      <input type="text" name="cp_itemname" id="cp_itemname"  value="" onkeyup="cp_addItem_keyup( event );" /> <input type="button" onclick="cp_addItem();" name="gobtn" value="<?php esc_attr_e( 'Add', 'calculated-fields-form' ); ?>" class="button-secondary" />
      <br /><br />
    </form>
  </div>
 </div>
